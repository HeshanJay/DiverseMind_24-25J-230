...
const VowelSymbolQ6 = ({ onAnswer, onBack }) => {
  ...
  // const correctAnswer = "ඇලපිල්ල, කෙටි ඉස්පිල්ල"; // Known to parent, no need here
  const answers = [
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-15 w-full flex justify-center">
        <div className="bg-gradient-to-r from-gray-300/80 to-blue-300/80 p-8 rounded-3xl shadow-lg w-[750px] h-[480px] relative border-4 border-blue-600">
          {/* Title */}
          <div className="mb-4 text-3xl font-extrabold text-center text-white bg-gradient-to-r from-blue-500 to-blue-700 bg-opacity-90 py-2 px-4 rounded-xl shadow-md">
            මෙම වචනයෙහි ඇති පිල්ලම් මොනවාද?
          </div>

          {/* Word Section */}
          <div className="mb-10 p-6 rounded-3xl shadow-lg bg-white text-center text-4xl font-bold text-blue-800 tracking-widest border-4 border-blue-500">
