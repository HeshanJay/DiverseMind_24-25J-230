    ...
    >
      ...
      <div className="bg-white bg-opacity-90 p-8 rounded-xl shadow-2xl max-w-3xl text-center border-4 border-yellow-400">
        ...
        <p className="text-xl text-gray-800 leading-relaxed">
          හේනේ මාමාගේ හේනට එහා කරඹ කැලේ එක මීයො රංචුවක් හිටියා. මේ මීයො රංචුවෙන්
          හේනේ මාමාට හරීම කරදරේ.හේනේ මාමා චුට්ටක් පෙනෙන්න නැති වෙනකල් ඉඳලා මි
          රංචුව හේනට පනිනවා. හේනේ මාමා මහන්සියෙන් හදාපු වගාව ඔක්කොම පාළු කරනවා එ
          විතර්ක් නෙමෙයි පොළොව හාරලා පැළත් පෙරළනවා.
          <br />
          <br />
          හේනේ මාමාට මේ ගැන හරි කේන්තියි. ඒත් එක හොර මීයෙක්වත් අල්ලගන්න නම්
