...
const G1_L3_Feedback = ({ activity1Score = 0, activity2Score = 0, handleRetry }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-200/90 via-cyan-300/100 to-teal-400/90 p-8 rounded-[2rem] shadow-md w-[520px] h-[520px] relative border-8 border-blue-700">
