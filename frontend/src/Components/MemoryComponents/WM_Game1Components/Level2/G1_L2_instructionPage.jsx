        ...
        <div className="flex justify-center w-full relative">
          ...
          <div className="bg-gradient-to-r from-blue-200/80 via-cyan-300/80 to-teal-400/80 p-8 rounded-[2rem] shadow-md w-[520px] h-[420px] relative border-8 border-blue-700">
            ...
            <img
              src={jellyfish2}
              alt="Jellyfish 2"
              className="absolute bottom-[-10px] right-[15px] w-[110px] h-auto transform rotate-[20deg] animate-float-reverse"
            />
...
{/* Instructions */}
<div className="-mt-1"> {/* Negative margin to move text up */}
  <p className="text-2xl md:text-3xl font-semibold text-center text-black mb-6">
    උපදෙස් නිවැරදිව කියවා පිළිතුරු සපයන්න.
  </p>
  <ul className="text-lg md:text-xl mb-10 list-disc list-inside leading-relaxed text-left text-black ml-10">
