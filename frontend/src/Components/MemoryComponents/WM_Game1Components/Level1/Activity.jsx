  ...
  const questionData = {
    1: {
      ...
      answers: [
        ...
        { text: "2. ගැහැණු ළමයින් දෙදෙනෙක් වෙළඳසැලක අයිස්ක්‍රීම් මිලදී ගනිමින් සිටි.", isCorrect: true },
        { text: "3. ගැහැණු ළමයින් දෙදෙනෙක් සාප්පු සවාරියේ යෙදෙති.", isCorrect: false },
        { text: "4. ගැහැණු ළමයා සහ පිරිමි ළමයා අයිස්ක්‍රීම් කමින් සිටි.", isCorrect: false },
      ],
    },
    2: {
      image: img3,
      answers: [
        { text: "1. ආච්චි, මව සහ දරුවන් දෙදෙනෙකු මුළුතැන්ගෙයි ආහාර ගනිමින් සිටි.", isCorrect: false },
        { text: "2. මව කෑම පිළියෙළ කරන අතර, ආච්චි සහ දරුවන් ආහාර ගනිමින් සිටි.", isCorrect: true },
        { text: "3. අම්මයි තාත්තයි දරුවන් සමඟ සංවාදයක යෙදෙති.", isCorrect: false },
        { text: "4. මව කෑම පිළියෙළ කරන අතර, ආච්චි සහ දරුවන් සංවාදයක යෙදෙති.", isCorrect: false },
      ],
    },
    3: {
      images: [img10],
      answers: [
        { text: "1. දූෂිත පරිසරය දැක දරුවන් කම්පනයට පත් වෙයි.", isCorrect: true},
        { text: "2. ළමයින් පරිසරය දෙස පුදුම වී බලා සිටියි.", isCorrect: false },
        { text: "3. ගඟක ළමයින් සතුටින් සෙල්ලම් කළහ.", isCorrect: false },
        { text: "4. දූෂිත ප්ලාස්ටික් දැක දරුවන් කම්පනයට පත් වෙයි.", isCorrect: false },
      ],
    },
    4: {
      images: [img14],
      answers: [
        ...
        { text: "2. ප්‍රීතිමත් ගොවියෙක් නැවුම් එළවළු අතැතිව ගොවිපලේ වැඩ කරයි.", isCorrect: true },
    ...
    5: {
      ...
      answers: [
        ...
        { text: "2. පවුල් සාමකාමී උද්‍යානයක විනෝද චාරිකාවක් පවත්වයි.", isCorrect: false },
        { text: "3. සැණකෙළිය සවාරි, ආහාර කඩ සහ ක්‍රීඩා රසවිඳින මිනිසුන්ගෙන් පිරී ඇත.", isCorrect: true },
        { text: "4. විනෝද උද්‍යානය රසවිඳින මිනිසුන්ගෙන් පිරී ඇත.", isCorrect: false },
      ],
    },
  };
...
<style jsx>{`
  ...
  @keyframes fish4 {
    0% { transform: translateX(0) scaleX(1); }
    50% { transform: translateX(400px) scaleX(1); } /* Increased distance */
    51% { transform: translateX(400px) scaleX(-1); } /* Increased distance */
    100% { transform: translateX(0) scaleX(-1); }
  }
  @keyframes fish5 {
    0% { transform: translateX(0) scaleX(1); }
    50% { transform: translateX(150px) scaleX(1); }
    51% { transform: translateX(150px) scaleX(-1); }
    100% { transform: translateX(0) scaleX(-1); }
  }
  @keyframes fish6 {
    0% { transform: translateX(0) scaleX(1); }
    50% { transform: translateX(120px) scaleX(1); }
    51% { transform: translateX(120px) scaleX(-1); }
    100% { transform: translateX(0) scaleX(-1); }
  }
  @keyframes flapFins {
    0% { transform: rotate(0deg); }
    25% { transform: rotate(10deg); } /* Flap fins outward */
    50% { transform: rotate(0deg); } /* Return to normal */
    75% { transform: rotate(-10deg); } /* Flap fins inward */
