...
const G3_L3_Feedback = ({ totalScore, handleRetry }) => {
  ...
  const feedbackMessage = () => {
    if (totalScore === 20) return "විශිෂ්ටයි! ඔබ සම්පූර්ණයෙන් සාර්ථකයි";
    if (totalScore >= 16) return "ඉතාමත් හොඳයි! ඔබ ඉතා හොඳින් කළා";
    if (totalScore >= 12) return "හොඳයි! ඔබ එය හොඳින් කළා";
    if (totalScore >= 8) return "සාමාන්යයි! තවත් පුහුණුව අවශ්යයි";
...
G3_L3_Feedback.propTypes = {
  totalScore: PropTypes.number.isRequired,
  handleRetry: PropTypes.func.isRequired
};

export default G3_L3_Feedback;