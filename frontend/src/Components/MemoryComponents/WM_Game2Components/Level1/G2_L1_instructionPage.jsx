  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-4">
          ...
          <div className="bg-gradient-to-r from-green-400/90 via-yellow-300/90 to-green-600/90 p-8 rounded-[2rem] shadow-md w-[520px] h-[420px] relative border-8 border-green-800">
            ...
            <div className="-mt-1">
              ...
              <ul className="text-lg md:text-xl mb-10 list-disc list-inside leading-relaxed text-left text-black ml-16">
                <li>නිවැරදිව ප්‍රශ්නය කියවන්න.</li>
        ...
        <button
          onClick={handleStart}
          className="mt-8 bg-gradient-to-r from-green-500 to-yellow-500 text-white text-xl md:text-2xl px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 hover:rotate-1"
        >
          ආරම්භ කරන්න
        </button>
      </div>
