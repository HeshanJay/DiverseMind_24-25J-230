  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "230px", marginTop: "-469px", marginLeft: "338px" }}
      >
        <img
        ...
        <div
          ...
          style={
            currentIndex === questionImages.length - 1
              ? { right: "15px", color: "yellow" }
              : { right: "15px" }
          }
        >
          <h2
            ...
            style={
              ...
              "3. ගමේ මිනිසුන් වැඩි වශයෙන් කුමන කර්මාන්තයක නිරත වෙයි?"
