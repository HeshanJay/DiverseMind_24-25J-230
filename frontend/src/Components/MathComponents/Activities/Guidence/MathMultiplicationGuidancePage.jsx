...
import "./MathMultiplicationGuidancePage.css"; // Import the CSS file
import bgWallpaper from "../../../../assets/background_images/bg-wallpaper_21.png";
import multiplicationVideo1 from "../../../../assets/Math/Mutiplication1.mp4";
import multiplicationVideo2 from "../../../../assets/Math/Mutiplication2.mp4";
import Confetti from "react-confetti"; // Import confetti library

const MathMultiplicationGuidancePage = () => {
  ...
  const videoSources = [multiplicationVideo1, multiplicationVideo2];
  ...
  const handleFinishClick = () => {
    navigate("/math-multiplication-game"); // Navigate to the next activity page
  };
  ...
  return (
    <div className="math-multiplication-guidance-page" style={{ backgroundImage: `url(${bgWallpaper})` }}>
      {/* Confetti Animation */}
...
export default MathMultiplicationGuidancePage;