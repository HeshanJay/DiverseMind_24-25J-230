...
import "./MathDivisionGuidancePage.css"; // Import the CSS file
import bgWallpaper from "../../../../assets/background_images/bg-wallpaper_21.png";
import divisionVideo1 from "../../../../assets/Math/Division_1.mp4";
import divisionVideo2 from "../../../../assets/Math/Division_2.mp4";
import Confetti from "react-confetti"; // Import confetti library

const MathDivisionGuidancePage = () => {
  ...
  const videoSources = [divisionVideo1, divisionVideo2];
  ...
  return (
    <div className="math-division-guidance-page" style={{ backgroundImage: `url(${bgWallpaper})` }}>
      {/* Confetti Animation */}
...
export default MathDivisionGuidancePage;