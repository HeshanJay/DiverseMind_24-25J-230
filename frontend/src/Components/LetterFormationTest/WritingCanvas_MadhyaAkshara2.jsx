...
import "./WritingCanvas_MadhyaAkshara2.css";
...
const WritingCanvas_MadhyaAkshara2 = ({ onNext, onBack }) => {
  ...
  return (
    ...
    >
      ...
      >
        ආයුබෝවන්! "ක" අකුර නිවැරදිව ලියමු.
      </div>
...
export default WritingCanvas_MadhyaAkshara2;
