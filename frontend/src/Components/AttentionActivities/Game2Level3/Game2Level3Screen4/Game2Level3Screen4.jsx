...
import Level3_4 from "../../../../assets/background_images/AttentionGames/Game2/Level3_4.png";
import Level3_4_1 from "../../../../assets/background_images/AttentionGames/Game2/Level3_4.1.png";
...
const Game2Level3Screen4 = ({ onTileSelect, onTimeout }) => {
  ...
  useEffect(() => {
    playClockAudio(); // Start ticking on mount

    const timer = setInterval(() => {
      setTimeLeft((prev) => {
        if (prev <= 1) {
          clearInterval(timer);
          stopClockAudio(); // Stop ticking
          setTimeout(() => {
            playTimeoutSound();
            onTimeout();
          }, 200);
    ...
    return () => {
      clearInterval(timer);
      stopClockAudio(); // Stop ticking on unmount
    };
  }, [onTimeout]);
  ...
  // There are 8 tiles; the correct answer is tile with id 1.
  const tiles = [
    { id: 1, image: Level3_4_1 },
    { id: 2, image: Level3_4 },
    { id: 3, image: Level3_4 },
    { id: 4, image: Level3_4 },
    { id: 5, image: Level3_4 },
...
export default Game2Level3Screen4;
