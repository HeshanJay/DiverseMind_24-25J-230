...
import elephantImage from "../../../assets/Attention/lion.png"; // lion image used as elephant image
import b2Image from "../../../assets/Attention/b7.png"; // score board image
...
const ColorChange = () => {
  ...
  // Generate 8 color options (instead of 6)
  ...
  // Timer countdown (only when game has started)
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {!gameStarted && !gameOver && (
        <div className="absolute inset-0 z-30 flex flex-col items-center justify-center p-4 bg-black bg-opacity-50">
          ...
          <div className="relative w-[2200px] md:w-[1000px] h-[1100px] mt-4 rounded-xl shadow-lg overflow-hidden">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 translate-y-6">
      ...
      {/* Top Left: Zebra & Elephant images with Timer and Round (when game started and not over) */}
      {gameStarted && !gameOver && (
        <div style={{ position: "absolute", top: 0, left: 0, zIndex: 60 }}>
          ...
          <div style={{ position: "relative", marginTop: "10px" }}>
            <img
              ...
              style={{ width: "250px", height: "auto" }}
            />
            {/* Display round on top-left of the elephant image */}
            <div
              style={{
                position: "absolute",
                top: "10px",
      ...
      {/* Score board using b2 image (when game started and not over) */}
      {gameStarted && !gameOver && (
        <div
          style={{
            position: "absolute",
      ...
      {/* Main Game Content (when game started and not over) */}
      {gameStarted && !gameOver && (
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="bg-white/50 p-6 rounded-xl shadow-lg text-center">
            ...
            {/* Grid layout with 4 columns for 8 options */}
