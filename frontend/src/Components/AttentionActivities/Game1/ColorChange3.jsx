...
import backgroundImage from "../../../assets/background_images/colorimg3.png";
...
const ColorChange3 = () => {
  ...
  const [bestScore, setBestScore] = useState(
    () => parseInt(localStorage.getItem("colorChange3BestScore")) || 0
  );
  ...
  const handleGuess = (guess) => {
    ...
    if (guess === rgbColor) {
      ...
      if (newScore > bestScore) {
        ...
        localStorage.setItem("colorChange3BestScore", newScore); // Save specific to ColorChange3
      }
      resetRound();
    } else {
      setFeedback("✗ Wrong!");
