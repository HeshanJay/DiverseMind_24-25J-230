    ...
    switch (door) {
      case 'writing':
        setIntermediateScreen({
          ...
          imageStyle: { width: '280px', height: '300px', position: 'absolute', bottom: '240px', left: '245px' },
      ...
      case 'attention':
        setIntermediateScreen({
          ...
          imageStyle: { width: '300px', height: '190px', position: 'absolute', bottom: '330px', right: '150px' },
          gradient: 'bg-gradient-to-r from-black to-black',
        });
        break;
      case 'maths':
        setIntermediateScreen({
          ...
          navigateTo: '/maths_menu',
          imageStyle: { width: '240px', height: '260px', position: 'absolute', bottom: '290px', left: '280px' },
          gradient: 'bg-gradient-to-r from-black to-black',
        });
        break;
      case 'memory':
        setIntermediateScreen({
          ...
          navigateTo: '/WM_Menu',
          imageStyle: { width: '230px', height: '200px', position: 'absolute', bottom: '310px', right: '190px' },
          gradient: 'bg-gradient-to-r from-black to-black',
        });
        break;
      default:
      ...
      />
        ...
        <div className="flex flex-col items-center w-full h-full relative">
          ...
          <div className="absolute bottom-[-200px] left-1/2 transform -translate-x-1/2">
            <img src={lion1} alt="Lion" className="w-70 h-60 object-cover rounded-full shadow-lg" />
          </div>
        </div>
      )}
    </div>
