...
//     console.log("Sending data to backend:", data);
//     try {
//       const response = await fetch("http://127.0.0.1:8000/save-memory-results/", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//     try {
//       const predictionResponse = await fetch("http://127.0.0.1:8000/working_memory_prediction/", {
//         method: "POST",
...
//         }),
//       });
//       if (!predictionResponse.ok) throw new Error(`Server Error: ${predictionResponse.status}`);
...
const WorkingMemory = () => {
  ...
  const handleAllFinished = async () => {
    ...
    const data = {
      student_id: "unknown", // Replace with actual student ID if available
